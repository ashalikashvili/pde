...
class Proxy
{
     ...
     * @var string
     */
    public static $AUTH_KEY = 'b689f974578c4fc1ab06f5dbb532af7b';
     ...
     * @var string
     */
    public static $HEADER_HTTP_PROXY_AUTH = 'X-Proxy-Auth';

    /**
     * Name of the target url header
     * @var string
     */
    public static $HEADER_HTTP_PROXY_TARGET_URL = 'X-Proxy-Target-Url';
    ...
    protected static function getTargetUrl()
    {
        if (!empty(static::$TARGET_URL)) {
            ...
            $targetURL = static::ri($headers[static::$HEADER_HTTP_PROXY_TARGET_URL]);
        }
    ...
    {
        $headers = getallheaders();
        return !static::$ENABLE_AUTH || static::ri($headers[static::$HEADER_HTTP_PROXY_AUTH]) === static::$AUTH_KEY;
    }
    ...
    public static function run()
    {
        ...
        foreach ($responseHeaders as $header) {
            ...
            if (in_array($loweredHeaderName,
                ['content-type', 'content-language', 'content-security', 'server', 'content-length'])) {
